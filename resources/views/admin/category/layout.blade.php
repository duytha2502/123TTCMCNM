...
<head>
    ...
    <link rel="stylesheet" href="resource/vendors/jqvmap/dist/jqvmap.min.css">
    <script src="resource/ckeditor/ckeditor.js"></script>
    <script type="text/javascript" src="resource/editor/ckeditor/ckeditor.js"></script>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" height="30" src="resource/images/ql.jpg" alt="User Avatar">
                        </a>
