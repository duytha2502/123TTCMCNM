...
<body>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand hidden" href="./"><img src="{!! asset('resource/images/logo2.png') !!}" alt="Logo"></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Người Dùng</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="{{route('trang-chu')}}">Chuyển Sang Index</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="{{route('getdangky')}}">Đăng Ký</a></li>
                        </ul>
                    </li> --}}
                </ul>
            </div><!-- /.navbar-collapse -->
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" height="30" src="{!! asset('resource/images/ql.jpg') !!}" alt="User Avatar">
                        </a>
        ...
        <script src="{!! asset('resource/vendors/jqvmap/dist/jquery.vmap.min.js') !!}"></script>
        <script src="{!! asset('resource/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js') !!}"></script>
        <script src="{!! asset('resource/vendors/jqvmap/dist/maps/jquery.vmap.world.js') !!}"></script>
        <script>
            (function($) {
                "use strict";
